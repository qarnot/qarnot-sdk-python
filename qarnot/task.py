...
from qarnot.exceptions import MissingTaskException, MaxTaskException, MissingDiskException, LockedDiskException, MaxDiskException, NotEnoughCreditsException
try:
