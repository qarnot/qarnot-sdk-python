...
latex_documents = [
    (master_doc, 'Qarnot.tex', u'Qarnot Documentation',
...
man_pages = [
    (master_doc, 'qarnot', u'Qarnot Documentation',
     [author], 1)
]
...
texinfo_documents = [
  ('index', 'qarnot', u'qarnot Documentation',
   u'Qarnot computing', 'qarnot', 'Qarnot computing Python SDK.',
   'Miscellaneous'),
]
